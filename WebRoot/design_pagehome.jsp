...
<div class="easyui-layout" data-options="fit:true"> 
	<div id='toolbar' class='easyui-panel' data-options="region:'north'" style="overflow:hidden; background-color: #E0ECFF; height:40px; padding: 8px 1px 0px 12px;">
