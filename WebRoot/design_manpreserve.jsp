...
<script>
	...
	$(function() {
		...
		pmyGrid1.gridfields='[#100]管理员编码/userid;[#100]姓名/username;[#100]电话号码/mobile;[#100]注册密码/password;[@c%b#170]Email/email;[%d#100]注册日期/registerdate';
		pmyGrid1.tablename='bm_users';
		pmyGrid1.title='选项编辑';
		pmyGrid1.keyfield='lendid';
		pmyGrid1.sortfield='';
		pmyGrid1.staticsql="select userid,username,mobile,email,password,registerdate from bm_mans";
